import { gigUpdateSchema } from '@gig/validators/gig';
import { updateActiveGigProp, updateGig } from '@gig/utils/gig.utils';
import { BadRequestError, ISellerGig, isDataURL, uploads } from '@chandrashekar2001/ecommerce-shared';

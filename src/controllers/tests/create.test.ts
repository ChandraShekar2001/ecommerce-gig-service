...
import { gigCreateSchema } from '@gig/validators/gig';
import { BadRequestError } from '@chandrashekar2001/ecommerce-shared';
import { Request, Response } from 'express';
import { gigCreate } from '@gig/controllers/create';
import * as helper from '@chandrashekar2001/ecommerce-shared';
import * as gigService from '@gig/utils/gig.utils';
import { authUserPayload, gigMockRequest, gigMockResponse, sellerGig } from '@gig/controllers/tests/mocks/gig.mock';

jest.mock('@gig/utils/gig.utils');
jest.mock('@chandrashekar2001/ecommerce-shared');
jest.mock('@gig/validators/gig');

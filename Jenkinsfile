...
serviceName = "ecommerce-gig"
service = "ecommerce gig"
...
pipeline {
  ...
  environment {
    ...
    IMAGE_NAME = "pvchandu07622" + "/" + "ecommerce-gig"
  ...
  stages {
    ...
    stage("Prepare Environment") {
      steps {
        ...
        git branch: 'main', credentialsId: 'github', url: 'https://github.com/ChandraShekar2001/ecommerce-gig-service'
